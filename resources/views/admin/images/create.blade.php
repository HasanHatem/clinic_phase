            ...
            <div class="card">
                ...
                <div class="form-wrapper">
                    ...
                    <div class="form">
                        ...
                        <form action="{{ route('admin.images.store') }}" method="POST" enctype="multipart/form-data" id="upload-image">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="image_alt" id="image_alt" class="@error('image_alt') is-invalid @enderror" value="{{ old('image_alt') }}" tabindex="2">
