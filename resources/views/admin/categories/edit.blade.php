...
@section('title')
    Edit {{ $category->translation->name }}
@endsection
                                    ...
                                    <div class="tab-pane {{ ($language->slug == 'en') ? 'active' : '' }}" data-tab-pane id="{{ $language->slug }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input id="{{ $language->slug }}_name" data-name type="text" class="@error($language->slug.'_name') is-invalid @enderror ar-text" name="{{ $language->slug }}_name" value="{{ $category->translation($language->slug)->first()->name }}" tabindex="1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input id="{{ $language->slug }}_slug" type="text" class="@error($language->slug.'_slug') is-invalid @enderror ar-text" name="{{ $language->slug }}_slug" value="{{ $category->translation($language->slug)->first()->slug }}" tabindex="2">
